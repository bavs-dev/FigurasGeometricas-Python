...
"""
 ...
 ciertos atributos en los cuales se manipula en el trancurso del proyecto asi como
 color, vertices, puntos etc 

"""
class Figura:
    # Método constructor de la clase Figura SOLO SE EJECUTA UNA VES CUANO LA CLASES LLMADA
    ...
    # Método que nos permite lllamar el metodo  del color para asi realizar las validaciones 
    ...
    def mover(self, event):
        ...
        # Ciclo que nos pemite buscar las figuras con el id y asi remplzar los vertices para tenelos actulizados 
    ...
    def agregar_flecha(self, punto_inicio, punto_destino, otra_figura):
        try:
            ...
            # Ciclo que nos permite recorrer las figruas y obtner la qu enecesitamos para asi poder manipular su puntos 
            for figura in figuras:
                if figura['idfigura'] == self.id_figura:
...
class DraggableImage:
    ...
    # Método que nos permite obteener y mover las figuras
...
# Clase para representar un cuadrado, heredando de Figura
...
# Clase para representar un triángulo, heredando de Figura
...
# Clase para representar un círculo, heredando de Figura
...
# Clase para representar un pentágono, heredando de Figura
...
# Clase para representar un hexágono, heredando de Figura
...
# Clase para representar un heptágono, heredando de Figura
...
# Clase para representar un octágono, heredando de Figura
...
# Clase para representar una estrella, heredando de Figura
...
class Aplicacion:
    ...
    # Abrir cuadro de diálogo para seleccionar el archivo PKL
        ...
        # Cargar el archivo PKL seleccionado
            ...
            # Limpiar el canvas antes de dibujar las figuras cargadas
                ...
                """
                Este clico recorre las figuras asi mismo cada ves que corrre las figuras obtenemos el tipo de esta misma
                ...
                for Recore in figuras:
                    ...
                    if Recore['tipo'] == 'circulo':
                        figura = Circulo(self.canvas)  # Crear una instancia de ciruclo
                        figura.color_figura =Recore['color']
                        figura.vertices = Recore['vertices']
                        figura.id_figura = Recore['idfigura']
    ...
    # Crear un diccionario de actualización basado en puntosnuevos
